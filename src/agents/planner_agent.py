...
class PlannerAgent:
    ...
    def _heuristic_plan(self, *, topic: str, template_category: str, conversation_state: Optional[Any]) -> ExecutionPlan:
        ...
        need_images = template_category in {"comprehensive", "teaching_design", "ppt"}
        ...
        if preferences.get("prefer_visual_lesson") and template_category in {"comprehensive", "teaching_design", "ppt"}:
            need_images = True
